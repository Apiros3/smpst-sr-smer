...
Proof.
  ...
  - inversion H5. subst. clear H5. inversion H8. subst. clear H8. 
    ...
    - specialize(_a23_a q xs (p_recv q xs) nil nil T Hb (eq_refl (p_recv q xs))); intros. 
      destruct H5 as (STT,(Hg,(Hh,(Hi,Hj)))).
    - specialize(_a23_bf p l e Q (p_send p l e Q) nil nil T1 He (eq_refl (p_send p l e Q))); intros.
